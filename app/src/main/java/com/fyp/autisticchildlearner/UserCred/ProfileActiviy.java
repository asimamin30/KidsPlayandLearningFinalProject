    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_Update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!validation()){
                    UserHelperClass helperClass = new UserHelperClass(str_fullName,username,str_phoneNo,str_email,str_password,str_nicNo);
                    ref.child(userType).child(username).setValue(helperClass)
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(getApplicationContext(),"Updation Successfully",Toast.LENGTH_SHORT).show();
                                }
                            });
                }
            }
